...
/*******************************************************************************
* Function Name: PWM_5_6_clk_Start
********************************************************************************
*
* Summary:
...
void PWM_5_6_clk_Start(void) 
{
    ...
    PWM_5_6_clk_CLKEN |= PWM_5_6_clk_CLKEN_MASK;
	PWM_5_6_clk_CLKSTBY |= PWM_5_6_clk_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: PWM_5_6_clk_Stop
********************************************************************************
*
* Summary:
...
void PWM_5_6_clk_Stop(void) 
{
    ...
    PWM_5_6_clk_CLKEN &= (uint8)(~PWM_5_6_clk_CLKEN_MASK);
	PWM_5_6_clk_CLKSTBY &= (uint8)(~PWM_5_6_clk_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: PWM_5_6_clk_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((PWM_5_6_clk_CLKEN & PWM_5_6_clk_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = PWM_5_6_clk_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = PWM_5_6_clk_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* PWM_5_6_clk__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(PWM_5_6_clk_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(PWM_5_6_clk_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: PWM_5_6_clk_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: PWM_5_6_clk_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = PWM_5_6_clk_GetSourceRegister();
    uint16 oldDivider = PWM_5_6_clk_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = PWM_5_6_clk_CLKEN & PWM_5_6_clk_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((PWM_5_6_clk_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: PWM_5_6_clk_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(PWM_5_6_clk_DIV_PTR);
}


/*******************************************************************************
* Function Name: PWM_5_6_clk_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    PWM_5_6_clk_MOD_SRC |= modeBitMask & (uint8)PWM_5_6_clk_MODE_MASK;
}


/*******************************************************************************
* Function Name: PWM_5_6_clk_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    PWM_5_6_clk_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(PWM_5_6_clk_MODE_MASK));
}


/*******************************************************************************
* Function Name: PWM_5_6_clk_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return PWM_5_6_clk_MOD_SRC & (uint8)(PWM_5_6_clk_MODE_MASK);
}


/*******************************************************************************
* Function Name: PWM_5_6_clk_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = PWM_5_6_clk_GetDividerRegister();
    uint8 oldSrc = PWM_5_6_clk_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        PWM_5_6_clk_MOD_SRC |= CYCLK_SSS;
        PWM_5_6_clk_MOD_SRC =
            (PWM_5_6_clk_MOD_SRC & (uint8)(~PWM_5_6_clk_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: PWM_5_6_clk_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return PWM_5_6_clk_MOD_SRC & PWM_5_6_clk_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: PWM_5_6_clk_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    PWM_5_6_clk_PHASE = clkPhase & PWM_5_6_clk_PHASE_MASK;
}


/*******************************************************************************
* Function Name: PWM_5_6_clk_GetPhase
********************************************************************************
*
* Summary:
...
{
    return PWM_5_6_clk_PHASE & PWM_5_6_clk_PHASE_MASK;
}
