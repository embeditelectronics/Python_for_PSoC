...
/*******************************************************************************
* Function Name: PWM_clk_3_4_Start
********************************************************************************
*
* Summary:
...
void PWM_clk_3_4_Start(void) 
{
    ...
    PWM_clk_3_4_CLKEN |= PWM_clk_3_4_CLKEN_MASK;
	PWM_clk_3_4_CLKSTBY |= PWM_clk_3_4_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: PWM_clk_3_4_Stop
********************************************************************************
*
* Summary:
...
void PWM_clk_3_4_Stop(void) 
{
    ...
    PWM_clk_3_4_CLKEN &= (uint8)(~PWM_clk_3_4_CLKEN_MASK);
	PWM_clk_3_4_CLKSTBY &= (uint8)(~PWM_clk_3_4_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: PWM_clk_3_4_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((PWM_clk_3_4_CLKEN & PWM_clk_3_4_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = PWM_clk_3_4_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = PWM_clk_3_4_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* PWM_clk_3_4__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(PWM_clk_3_4_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(PWM_clk_3_4_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: PWM_clk_3_4_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: PWM_clk_3_4_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = PWM_clk_3_4_GetSourceRegister();
    uint16 oldDivider = PWM_clk_3_4_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = PWM_clk_3_4_CLKEN & PWM_clk_3_4_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((PWM_clk_3_4_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: PWM_clk_3_4_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(PWM_clk_3_4_DIV_PTR);
}


/*******************************************************************************
* Function Name: PWM_clk_3_4_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    PWM_clk_3_4_MOD_SRC |= modeBitMask & (uint8)PWM_clk_3_4_MODE_MASK;
}


/*******************************************************************************
* Function Name: PWM_clk_3_4_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    PWM_clk_3_4_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(PWM_clk_3_4_MODE_MASK));
}


/*******************************************************************************
* Function Name: PWM_clk_3_4_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return PWM_clk_3_4_MOD_SRC & (uint8)(PWM_clk_3_4_MODE_MASK);
}


/*******************************************************************************
* Function Name: PWM_clk_3_4_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = PWM_clk_3_4_GetDividerRegister();
    uint8 oldSrc = PWM_clk_3_4_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        PWM_clk_3_4_MOD_SRC |= CYCLK_SSS;
        PWM_clk_3_4_MOD_SRC =
            (PWM_clk_3_4_MOD_SRC & (uint8)(~PWM_clk_3_4_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: PWM_clk_3_4_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return PWM_clk_3_4_MOD_SRC & PWM_clk_3_4_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: PWM_clk_3_4_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    PWM_clk_3_4_PHASE = clkPhase & PWM_clk_3_4_PHASE_MASK;
}


/*******************************************************************************
* Function Name: PWM_clk_3_4_GetPhase
********************************************************************************
*
* Summary:
...
{
    return PWM_clk_3_4_PHASE & PWM_clk_3_4_PHASE_MASK;
}
