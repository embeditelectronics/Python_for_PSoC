...
/*******************************************************************************
* Function Name: PWM_clk_7_8_Start
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_Start(void) 
{
    /* Set the bit to enable the clock. */
    PWM_clk_7_8_CLKEN |= PWM_clk_7_8_CLKEN_MASK;
	PWM_clk_7_8_CLKSTBY |= PWM_clk_7_8_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: PWM_clk_7_8_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    PWM_clk_7_8_CLKEN &= (uint8)(~PWM_clk_7_8_CLKEN_MASK);
	PWM_clk_7_8_CLKSTBY &= (uint8)(~PWM_clk_7_8_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: PWM_clk_7_8_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_StopBlock(void) 
{
    if ((PWM_clk_7_8_CLKEN & PWM_clk_7_8_CLKEN_MASK) != 0u)
    {
...
#if defined(PWM_clk_7_8__CFG3)
        CLK_DIST_AMASK = PWM_clk_7_8_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = PWM_clk_7_8_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* PWM_clk_7_8__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(PWM_clk_7_8_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(PWM_clk_7_8_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: PWM_clk_7_8_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        PWM_clk_7_8_CLKSTBY &= (uint8)(~PWM_clk_7_8_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: PWM_clk_7_8_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = PWM_clk_7_8_GetSourceRegister();
    uint16 oldDivider = PWM_clk_7_8_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = PWM_clk_7_8_CLKEN & PWM_clk_7_8_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((PWM_clk_7_8_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: PWM_clk_7_8_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 PWM_clk_7_8_GetDividerRegister(void) 
{
    return CY_GET_REG16(PWM_clk_7_8_DIV_PTR);
}


/*******************************************************************************
* Function Name: PWM_clk_7_8_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_SetModeRegister(uint8 modeBitMask) 
{
    PWM_clk_7_8_MOD_SRC |= modeBitMask & (uint8)PWM_clk_7_8_MODE_MASK;
}


/*******************************************************************************
* Function Name: PWM_clk_7_8_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_ClearModeRegister(uint8 modeBitMask) 
{
    PWM_clk_7_8_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(PWM_clk_7_8_MODE_MASK));
}


/*******************************************************************************
* Function Name: PWM_clk_7_8_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 PWM_clk_7_8_GetModeRegister(void) 
{
    return PWM_clk_7_8_MOD_SRC & (uint8)(PWM_clk_7_8_MODE_MASK);
}


/*******************************************************************************
* Function Name: PWM_clk_7_8_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = PWM_clk_7_8_GetDividerRegister();
    uint8 oldSrc = PWM_clk_7_8_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        PWM_clk_7_8_MOD_SRC |= CYCLK_SSS;
        PWM_clk_7_8_MOD_SRC =
            (PWM_clk_7_8_MOD_SRC & (uint8)(~PWM_clk_7_8_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: PWM_clk_7_8_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 PWM_clk_7_8_GetSourceRegister(void) 
{
    return PWM_clk_7_8_MOD_SRC & PWM_clk_7_8_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: PWM_clk_7_8_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void PWM_clk_7_8_SetPhaseRegister(uint8 clkPhase) 
{
    PWM_clk_7_8_PHASE = clkPhase & PWM_clk_7_8_PHASE_MASK;
}


/*******************************************************************************
* Function Name: PWM_clk_7_8_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 PWM_clk_7_8_GetPhaseRegister(void) 
{
    return PWM_clk_7_8_PHASE & PWM_clk_7_8_PHASE_MASK;
}
