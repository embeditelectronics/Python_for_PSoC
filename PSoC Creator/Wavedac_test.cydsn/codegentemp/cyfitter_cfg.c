...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)(0x48000080u + CYAPP_ECC_OFFSET))
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)(0x480005C8u + CYAPP_ECC_OFFSET))

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)(0x480005D0u + CYAPP_ECC_OFFSET))
