...
void PWM_2_Init(void) 
{
        ...
        ctrl = PWM_2_CONTROL & ((uint8)(~PWM_2_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_2_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void PWM_2_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        PWM_2_CONTROL &= ((uint8)(~(PWM_2_CTRL_CMPMODE1_MASK | PWM_2_CTRL_CMPMODE2_MASK))); 
...
void PWM_2_WritePeriod(uint16 period) 
{
    ...
    *******************************************************************************/
    uint8 PWM_2_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_2_STATUS_PTR);
    	return (result);
    }
