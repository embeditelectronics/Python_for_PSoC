...
void PWM_3_Init(void) 
{
        ...
        ctrl = PWM_3_CONTROL & ((uint8)(~PWM_3_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_3_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void PWM_3_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        PWM_3_CONTROL &= ((uint8)(~(PWM_3_CTRL_CMPMODE1_MASK | PWM_3_CTRL_CMPMODE2_MASK))); 
...
void PWM_3_WritePeriod(uint16 period) 
{
    ...
    *******************************************************************************/
    uint8 PWM_3_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_3_STATUS_PTR);
    	return (result);
    }
