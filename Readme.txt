...
1. The PSoC Creator folder contains several PSoC Creator projects which include the API and examples, created in PSoC Creator 3.0 SP1:
...
3. The Documentation folder includes html documentation of the Python API. Open the "index" file using your web browser to view it.